const Footer = () => {
  ...
  return (
    <footer className="bg-[#12131e] pt-12">
      {/*  =====Footer Top======= */}
      <div className="container">
        <div className="sm:flex items-center justify-between md:gap-8">
          ...
          <div className="w-full sm:w-1/2 ">
            ...
            <div className="flex items-center gap-4 fex-wrap md:gap-8 mt-10">
        ...
        <ul className="flex items-center justify-center md:gap-10 sm:gap-2 mt-10">
          <li>
